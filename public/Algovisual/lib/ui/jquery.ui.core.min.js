...
if (!c.ui.version) {
  ...
  c.fn.extend({
    ...
    disableSelection : function() {
      return this.bind((c.support.selectstart ? "selectstart" : "mousedown") +
                           ".ui-disableSelection",
  ...
  c.each([ "Width", "Height" ], function(a, b) {
    ...
    c.fn["outer" + b] = function(f, g) {
      ...
      return this.each(
          function() { c(this).css(h, d(this, f, true, g) + "px") })
    }
  });
  c.extend(c.expr[":"], {
  ...
  c.extend(c.ui, {
    ...
    isOver : function(
        a, b, d, e, h,
        i) { return c.ui.isOverAxis(a, d, h) && c.ui.isOverAxis(b, e, i) }
  })
}
})(jQuery);
