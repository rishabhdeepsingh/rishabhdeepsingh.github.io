...
c.widget("ui.accordion", {
  ...
  _create : function() {
    ...
    a.headers.attr("role", "tab")
        .bind("keydown.accordion", function(f) { return a._keydown(f) })
        .next()
        .attr("role", "tabpanel");
    a.headers.not(a.active || "")
        .attr({
          "aria-expanded" : "false",
          "aria-selected" : "false",
          tabIndex : -1
    ...
    b.event &&
        a.headers.bind(b.event.split(" ").join(".accordion ") + ".accordion",
                       function(f) {
  ...
  _setOption : function(a, b) {
    ...
    if (a == "disabled")
      this.headers.add(this.headers.next())[b ? "addClass" : "removeClass"](
          "ui-accordion-disabled ui-state-disabled")
  },
  _keydown : function(a) {
    if (!(this.options.disabled || a.altKey || a.ctrlKey)) {
      var b = c.ui.keyCode, d = this.headers.length,
          h = this.headers.index(a.target), f = false;
      switch (a.keyCode) {
      case b.RIGHT:
      case b.DOWN:
  ...
  resize : function() {
    ...
    if (a.fillSpace) {
      ...
      b = 0;
      this.headers.next()
          .each(function() { b = Math.max(b, c(this).height("").height()) })
          .height(b)
    }
    return this
  },
  ...
  _findActive : function(a) {
    return a ? typeof a === "number" ? this.headers.filter(":eq(" + a + ")")
  ...
  _toggle : function(a, b, d, h, f) {
    ...
    if (e.animated) {
      ...
      if (k && !h[k] && !c.easing[k])
        k = "slide";
      h[k] || (h[k] = function(
                   l) { this.slide(l, {easing : k, duration : i || 700}) });
      h[k](d)
    } else {
      if (e.collapsible && h)
        a.toggle();
    ...
    slide : function(a, b) {
      ...
      if (a.toHide.size())
        if (a.toShow.size()) {
          ...
          b = a.toShow;
          e = b[0].style.width;
          b.width(parseInt(b.parent().width(), 10) -
        ...
        a.toShow.animate(
            {height : "show", paddingTop : "show", paddingBottom : "show"}, a)
    },
