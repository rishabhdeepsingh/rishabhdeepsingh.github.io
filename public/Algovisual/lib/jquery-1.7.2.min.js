  ...
  if (!cj[a]) {
    ...
    if (e === "none" || e === "") {
      ...
      if (!cl || !ck.createElement)
        ...
        cl.write((f.support.boxModel ? "<!doctype html>" : "") +
                 "<html><body>"),
        cl.close();
      d = cl.createElement(a), cl.body.appendChild(d), e = f.css(d, "display"),
      b.removeChild(ck)
    }
    cj[a] = e
  }
...
function bn(a) {
  ...
  b === "input"
      ? bm(a)
      : b !== "script" && typeof a.getElementsByTagName != "undefined" &&
...
function bk(a, b) {
  ...
  b.nodeType === 1 &&
      (b.clearAttributes && b.clearAttributes(),
       ...
       b.removeAttribute(f.expando), b.removeAttribute("_submit_attached"),
...
function n(a, b, c) {
  ...
  h && (c === "queue" || !f._data(a, e)) && (c === "mark" || !f._data(a, g)) &&
      setTimeout(function() {
...
var c = a.document, d = a.navigator, e = a.location, f = function() {
  ...
  var e = function(a, b) { return new e.fn.init(a, b, h) }, f = a.jQuery,
      g = a.$, h, i = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, j = /\S/,
      k = /^\s+/, l = /\s+$/, m = /^<(\w+)\s*\/?>(?:<\/\1>)?$/,
      n = /^[\],:{}\s]*$/, o = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,
      p = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
      q = /(?:^|:|,)(?:\s*\[)+/g, r = /(webkit)[ \/]([\w.]+)/,
      s = /(opera)(?:.*version)?[ \/]([\w.]+)/, t = /(msie) ([\w.]+)/,
      u = /(mozilla)(?:.*? rv:([\w.]+))?/, v = /-([a-z]|[0-9])/ig, w = /^-ms-/,
      x = function(a, b) { return (b + "").toUpperCase() }, y = d.userAgent, z,
      A, B, C = Object.prototype.toString, D = Object.prototype.hasOwnProperty,
      E = Array.prototype.push, F = Array.prototype.slice,
...
f.Callbacks = function(a) {
  ...
  var c = [], d = [], e, i, j, k, l, m, n = function(b) {
    ...
    f = f || [], e = !a.memory || [ b, f ], i = !0, j = !0, m = k || 0, k = 0,
    l = c.length;
    for (; c && m < l; m++)
...
f.extend({
  Deferred : function(a) {
    var b = f.Callbacks("once memory"), c = f.Callbacks("once memory"),
        d = f.Callbacks("memory"), e = "pending",
    ...
    i.done(function() { e = "resolved" }, c.disable, d.lock)
        .fail(function() { e = "rejected" }, b.disable, d.lock),
        a && a.call(i, i);
    return i
  },
  when : function(a) {
    ...
    var b = i.call(arguments, 0), c = 0, d = b.length, e = Array(d), g = d,
        h = d, j = d <= 1 && a && f.isFunction(a.promise) ? a : f.Deferred(),
        k = j.promise();
    if (d > 1) {
      for (; c < d; c++)
    ...
    f.support = function() {
      ...
      i = p.getElementsByTagName("input")[0], b = {
      ...
      f.boxModel = b.boxModel = c.compatMode === "CSS1Compat", i.checked = !0,
      ...
      !p.addEventListener && p.attachEvent && p.fireEvent &&
          (p.attachEvent("onclick", function() { b.noCloneEvent = !1 }),
           p.cloneNode(!0).fireEvent("onclick")),
          i = c.createElement("input"), i.value = "t",
          i.setAttribute("type", "radio"), b.radioValue = i.value === "t",
          i.setAttribute("checked", "checked"), i.setAttribute("name", "t"),
          p.appendChild(i), j = c.createDocumentFragment(),
          j.appendChild(p.lastChild),
          b.checkClone = j.cloneNode(!0).cloneNode(!0).lastChild.checked,
          b.appendChecked = i.checked, j.removeChild(i), j.appendChild(p);
      if (p.attachEvent)
      ...
      j.removeChild(p), j = g = h = p = i = null, f(function() {
        var d, e, g, h, i, j, l, m, n, q, r, s, t,
            u = c.getElementsByTagName("body")[0];
        !u || (m = 1, t = "padding:0;margin:0;border:",
               r = "position:absolute;top:0;left:0;width:1px;height:1px;",
               s = t + "0;visibility:hidden;",
               n = "style='" + r + t + "5px solid #000;",
               q = "<div " + n + "display:block;'><div style='" + t +
                   "0;display:block;overflow:hidden;'></div></div>" +
                   "<table " + n + "' cellpadding='0' cellspacing='0'>" +
                   "<tr><td></td></tr></table>",
               d = c.createElement("div"),
               d.style.cssText =
                   s + "width:0;height:0;position:static;top:0;margin-top:" +
                   m + "px",
               u.insertBefore(d, u.firstChild), p = c.createElement("div"),
               d.appendChild(p),
               p.innerHTML = "<table><tr><td style='" + t +
                             "0;display:none'></td><td>t</td></tr></table>",
               k = p.getElementsByTagName("td"), o = k[0].offsetHeight === 0,
               k[0].style.display = "", k[1].style.display = "none",
               b.reliableHiddenOffsets = o && k[0].offsetHeight === 0,
               a.getComputedStyle &&
                   (p.innerHTML = "", l = c.createElement("div"),
                    l.style.width = "0", l.style.marginRight = "0",
                    p.style.width = "2px", p.appendChild(l),
               ...
               typeof p.style.zoom != "undefined" &&
                   (p.innerHTML = "", p.style.width = p.style.padding = "1px",
                    p.style.border = 0, p.style.overflow = "hidden",
                    p.style.display = "inline", p.style.zoom = 1,
                    b.inlineBlockNeedsLayout = p.offsetWidth === 3,
                    p.style.display = "block", p.style.overflow = "visible",
                    p.innerHTML = "<div style='width:5px;'></div>",
                    b.shrinkWrapBlocks = p.offsetWidth !== 3),
               p.style.cssText = r + s, p.innerHTML = q, e = p.firstChild,
               g = e.firstChild, i = e.nextSibling.firstChild.firstChild, j = {
                 doesNotAddBorder : g.offsetTop !== 5,
                 doesAddBorderForTableAndCells : i.offsetTop === 5
               },
               g.style.position = "fixed", g.style.top = "20px",
               j.fixedPosition = g.offsetTop === 20 || g.offsetTop === 15,
               g.style.position = g.style.top = "", e.style.overflow = "hidden",
...
f.extend({
  ...
  acceptData : function(a) {
    ...
    f.fn.extend({
      ...
      removeData : function(
          a) { return this.each(function() { f.removeData(this, a) }) }
    }),
    f.extend({
      _mark : function(a, b) {
      ...
      queue : function(a, b, c) {
        var d;
        if (a) {
          b = (b || "fx") + "queue", d = f._data(a, b),
          c && (!d || f.isArray(c) ? d = f._data(a, b, f.makeArray(c))
                                   : d.push(c));
          return d || []
        }
      },
      dequeue : function(a, b) {
        ...
        d === "inprogress" && (d = c.shift()),
            d && (b === "fx" && c.unshift("inprogress"),
                  f._data(a, b + ".run", e),
                  d.call(a, function() { f.dequeue(a, b) }, e)),
    ...
    f.fn.extend({
      ...
      dequeue : function(
          a) { return this.each(function() { f.dequeue(this, a) }) },
      delay : function(a, b) {
...
f.fn.extend({
  attr : function(
      a, b) { return f.access(this, f.attr, a, b, arguments.length > 1) },
  removeAttr : function(
      a) { return this.each(function() { f.removeAttr(this, a) }) },
  prop : function(
      a, b) { return f.access(this, f.prop, a, b, arguments.length > 1) },
  ...
  addClass : function(a) {
    ...
    if (f.isFunction(a))
      return this.each(function(
          b) { f(this).addClass(a.call(this, b, this.className)) });
  ...
  removeClass : function(a) {
    ...
    if (f.isFunction(a))
      return this.each(function(
          b) { f(this).removeClass(a.call(this, b, this.className)) });
  ...
  toggleClass : function(a, b) {
    ...
    if (f.isFunction(a))
      return this.each(function(
          c) { f(this).toggleClass(a.call(this, c, this.className, b), b) });
    return this.each(function() {
      if (c === "string") {
  ...
  val : function(a) {
    ...
    f.extend({
      ...
      removeAttr : function(a, b) {
        ...
        if (b && a.nodeType === 1) {
          ...
          for (; i < g; i++)
            e = d[i],
            e && (c = f.propFix[e] || e, h = u.test(e), h || f.attr(a, e, ""),
        ...
        tabIndex : {
          get : function(a) {
            ...
            return c && c.specified
                       ? parseInt(c.value, 10)
                       : s.test(a.nodeName) || t.test(a.nodeName) && a.href ? 0
                                                                            : b
          }
        }
      }
        ...
        (y = {
         ...
         w = f.valHooks.button = {
           get : function(a, c) {
             ...
             return d && (y[c] ? d.nodeValue !== "" : d.specified) ? d.nodeValue
                                                                   : b
           },
           set : function(a, b, d) {
    ...
    f.support.checkOn || f.each([ "radio", "checkbox" ], function() {
      f.valHooks[this] = {
        get : function(
            a) { return a.getAttribute("value") === null ? "on" : a.value }
      }
...
var z = /^(?:textarea|input|select)$/i, A = /^([^\.]*)?(?:\.(.+))?$/,
    ...
    F = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, G = function(a) {
      ...
      return f.event.special.hover ? a
...
f.event = {
  add : function(a, c, d, e, g) {
    ...
    if (!(a.nodeType === 3 || a.nodeType === 8 || !c || !d ||
      ...
      d.handler && (p = d, d = p.handler, g = p.selector),
          ...
          j = h.events, j || (h.events = j = {}), i = h.handle,
  ...
  remove : function(a, b, c, d, e) {
    ...
    if (!!g && !!(o = g.events)) {
      ...
      for (h = 0; h < b.length; h++) {
        ...
        p = f.event.special[j] || {},
        j = (d ? p.delegateType : p.bindType) || j, r = o[j] || [],
        m = r.length,
        l = l ? new RegExp("(^|\\.)" +
                           l.split(".").sort().join("\\.(?:.*\\.)?") +
                           "(\\.|$)")
      ...
      f.isEmptyObject(o) && (q = g.handle, q && (q.elem = null),
  ...
  trigger : function(c, d, e, g) {
    if (!e || e.nodeType !== 3 && e.nodeType !== 8) {
      ...
      if ((!e || f.event.customEvent[h]) && !f.event.global[h])
        return;
      c = typeof c == "object" ? c[f.expando] ? c : new f.Event(h, c)
                               : new f.Event(h),
      c.type = h, c.isTrigger = !0, c.exclusive = k, c.namespace = i.join("."),
      c.namespace_re =
          c.namespace
              ? new RegExp("(^|\\.)" + i.join("\\.(?:.*\\.)?") + "(\\.|$)")
              : null,
      ...
      for (l = 0; l < r.length && !c.isPropagationStopped(); l++)
        ...
        q && q.apply(m, d), q = o && m[o],
        q && f.acceptData(m) && q.apply(m, d) === !1 && c.preventDefault();
      c.type = h,
      !g && !c.isDefaultPrevented() &&
          (!p._default || p._default.apply(e.ownerDocument, d) === !1) &&
          (h !== "click" || !f.nodeName(e, "a")) && f.acceptData(e) && o &&
          e[h] &&
          (h !== "focus" && h !== "blur" || c.target.offsetWidth !== 0) &&
          !f.isWindow(e) &&
          (n = e[o], n && (e[o] = null), f.event.triggered = h, e[h](),
  ...
  dispatch : function(c) {
    ...
    var d = (f._data(this, "events") || {})[c.type] || [], e = d.delegateCount,
        ...
        i = f.event.special[c.type] || {}, j = [], k, l, m, n, o, p, q, r, s, t,
        u;
    ...
    if (!i.preDispatch || i.preDispatch.call(this, c) !== !1) {
      ...
      for (k = 0; k < j.length && !c.isPropagationStopped(); k++) {
        ...
        for (l = 0; l < q.matches.length && !c.isImmediatePropagationStopped();
             l++) {
          s = q.matches[l];
          if (h || !c.namespace && !s.namespace ||
              c.namespace_re && c.namespace_re.test(s.namespace))
            c.data = s.data, c.handleObj = s,
  ...
  mouseHooks : {
    ...
    filter : function(a, d) {
      ...
      a.pageX == null && d.clientX != null &&
          (e = a.target.ownerDocument || c, f = e.documentElement, g = e.body,
           a.pageX = d.clientX + (f && f.scrollLeft || g && g.scrollLeft || 0) -
                     (f && f.clientLeft || g && g.clientLeft || 0),
           a.pageY = d.clientY + (f && f.scrollTop || g && g.scrollTop || 0) -
  ...
  special : {
    ...
    beforeunload : {
      setup : function(a, b,
                       c) { f.isWindow(this) && (this.onbeforeunload = c) },
      teardown : function(
          a, b) { this.onbeforeunload === b && (this.onbeforeunload = null) }
    }
  },
  simulate : function(a, b, c, d) {
    ...
    f.event
        .handle = f.event.dispatch,
 f.removeEvent =
     c.removeEventListener
         ? function(
               a, b,
               c) { a.removeEventListener && a.removeEventListener(b, c, !1) }
 ...
 f.each({mouseenter : "mouseover", mouseleave : "mouseout"},
        function(a, b) {
          f.event.special[a] = {
            ...
            bindType : b,
            handle : function(a) {
              var c = this, d = a.relatedTarget, e = a.handleObj,
                  g = e.selector, h;
              if (!d || d !== c && !f.contains(c, d))
                a.type = e.origType, h = e.handler.apply(this, arguments),
                a.type = b;
              return h
            }
          }
 ...
 f.support.focusinBubbles ||
     f.each(
         ...
         function(a, b) {
           var d = 0,
               e = function(
                   a) { f.event.simulate(b, a.target, f.event.fix(a), !0) };
           f.event.special[b] = {
             setup : function() { d++ === 0 && c.addEventListener(a, e, !0) },
             teardown :
                 function() { --d === 0 && c.removeEventListener(a, e, !0) }
           }
         }),
 f.fn.extend({
   on : function(a, c, d, e, g) {
     ...
     d == null && e == null
         ? (e = c, d = c = b)
         : e == null &&
               (typeof c == "string" ? (e = d, d = b) : (e = d, d = c, c = b));
     if (e === !1)
       e = J;
     else if (!e)
       return this;
 ...
 function() {
   ...
   var m = function(b, d, e, f) {
     ...
     if (w.length > 1 && p.exec(b))
       ...
       !f && w.length > 1 && d.nodeType === 9 && !v && o.match.ID.test(w[0]) &&
   ...
   m.matchesSelector = function(
       a, b) { return m(b, null, null, [ a ]).length > 0 },
   m.find = function(a, b, c) {
     ...
     var f, g, h, i, j, k, l, n, p, q = a, r = [], s = c,
                                    t = c && c[0] && m.isXML(c[0]);
     while (a && c.length) {
       for (h in o.filter)
   ...
   var n = m.getText =
     ...
     return e
       ...
       o = m.selectors = {
             ...
             for (var f = 0, g = a.length, h; f < g; f++)
               if (h = a[f]) {
                 while ((h = h.previousSibling) && h.nodeType !== 1)
                   ;
                 a[f] = e || h && h.nodeName.toLowerCase() === b ? h || !1
                                                                 : h === b
               }
             e && m.filter(b, a, !0)
           },
         ...
         filters : {
           enabled : function(
               a) { return a.disabled === !1 && a.type !== "hidden" },
           ...
           text : function(a) {
             ...
             return a.nodeName.toLowerCase() === "input" && "text" === c &&
                    (b === c || b === null)
           },
           radio : function(a) {
           ...
           input : function(
               a) { return /input|select|textarea|button/i.test(a.nodeName) },
         ...
         filter : {
           ...
           ID : function(
               a, b) { return a.nodeType === 1 && a.getAttribute("id") === b },
           TAG : function(a, b) {
   ...
   for (var r in o.match)
     o.match[r] =
         new RegExp(o.match[r].source + /(?![^\[]*\])(?![^\(]*\))/.source),
   ...
   c.documentElement.compareDocumentPosition
       ...
       : (u =
           ...
           a.appendChild(c.createComment("")),
               ...
               a.firstChild &&
                   ...
                   (o.attrHandle.href = function(
                        a) { return a.getAttribute("href", 2) }),
               a = null
         }(),
         c.querySelectorAll &&
             function() {
                 ...
                 m = function(b, e, f, g) {
                   ...
                   if (!g && !m.isXML(e)) {
                     ...
                     if (e.nodeType === 9) {
                       ...
                       var k = e, l = e.getAttribute("id"), n = l || d,
                           p = e.parentNode, q = /^\s*[+~]/.test(b);
                       l ? n = n.replace(/'/g, "\\$&")
                         : e.setAttribute("id", n),
                           q && p && (e = e.parentNode);
                       try {
                         if (!q || p)
                           return s(e.querySelectorAll("[id='" + n + "'] " + b),
                                    f)
                       } catch (r) {
                       } finally {
         ...
         c.documentElement.contains
             ? m.contains = function(
                   a, b) { return a !== b && (a.contains ? a.contains(b) : !0) }
             : c.documentElement.compareDocumentPosition
                   ? m.contains = function(
                         a, b) { return !!(a.compareDocumentPosition(b) & 16) }
   ...
   m.attr = f.attr, m.selectors.attrMap = {}, f.find = m, f.expr = m.selectors,
   f.expr[":"] = f.expr.filters, f.unique = m.uniqueSort, f.text = m.getText,
   f.isXMLDoc = m.isXML, f.contains = m.contains
 }();
var L = /Until$/, M = /^(?:parents|prevUntil|prevAll)/, N = /,/,
    O = /^.[^:#\[\.,]*$/, P = Array.prototype.slice, Q = f.expr.match.globalPOS,
...
f.fn.extend({
  ...
  is : function(a) {
    return !!a && (typeof a == "string"
                       ? Q.test(a) ? f(a, this.context).index(this[0]) >= 0
  ...
  andSelf : function() { return this.add(this.prevObject) }
    ...
    f.each({
      ...
      siblings : function(
          a) { return f.sibling((a.parentNode || {}).firstChild, a) },
           ...
           function(a, b) {
             f.fn[a] = function(c, d) {
               ...
               L.test(a) || (d = c),
                   ...
                   (this.length > 1 || N.test(d)) && M.test(a) &&
                       (e = e.reverse());
    ...
    f.extend({
      filter : function(a, b, c) {
        c && (a = ":not(" + a + ")");
        return b.length === 1 ? f.find.matchesSelector(b[0], a) ? [ b[0] ] : []
                              : f.find.matches(a, b)
      },
      dir : function(a, c, d) {
        var e = [], g = a[c];
...
var V = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
    ...
    Z = /<([\w:]+)/, $ = /<tbody/i, _ = /<|&#?\w+;/, ba = /<(?:script|style)/i,
...
bg
    .optgroup = bg.option,
  bg.tbody = bg.tfoot = bg.colgroup = bg.caption = bg.thead, bg.th = bg.td,
  ...
  f.fn.extend({
    ...
    domManip : function(a, c, d) {
      ...
      if (this[0]) {
        i = j && j.parentNode,
        f.support.parentNode &&i &&i.nodeType === 11 &&i.childNodes.length ===
                this.length
            ? e = {fragment : i}
  ...
  f.buildFragment =
    ...
    b && b[0] && (i = b[0].ownerDocument || b[0]),
        ...
        a.length === 1 && typeof j == "string" && j.length < 512 && i === c &&
    ...
    replaceAll : "replaceWith"
         ...
         function(a, b) {
           f.fn[a] = function(c) {
             ...
             if (g && g.nodeType === 11 && g.childNodes.length === 1 &&
                 e.length === 1) {
               e[b](this[0]);
               return this
             }
  ...
  f.extend({
    clone : function(a, b, c) {
      var d, e, g,
          h = f.support.html5Clone || f.isXMLDoc(a) ||
                      !bc.test("<" + a.nodeName + ">")
                  ? a.cloneNode(!0)
                  : bo(a);
      if ((!f.support.noCloneEvent || !f.support.noCloneChecked) &&
          (a.nodeType === 1 || a.nodeType === 11) && !f.isXMLDoc(a)) {
        ...
        if (typeof l == "string")
          if (!_.test(l))
            ...
            var m = (Z.exec(l) || [ "", "" ])[1].toLowerCase(),
                n = bg[m] || bg._default, o = n[0], p = b.createElement("div"),
                q = bh.childNodes, r;
...
f.fn.css =
  ...
  return f.access(
      this,
      function(a, c, d) { return d !== b ? f.style(a, c, d) : f.css(a, c) }, a,
               ...
               (d = a.ownerDocument.defaultView) &&
                   ...
                   (c = e.getPropertyValue(b),
                    c === "" &&
                        ...
                        (c = f.style(a, b))),
               !f.support.pixelMargin && e && bv.test(b) && bt.test(c) &&
    ...
    c.documentElement.currentStyle &&
        (bA =
             function(a, b) {
               ...
               f == null && g && (e = g[b]) && (f = e),
                   bt.test(f) &&
                       (c = g.left, d = a.runtimeStyle && a.runtimeStyle.left,
               ...
               get : function(a, c, d) {
                 if (c)
                   return a.offsetWidth !== 0
                              ? bB(a, b, d)
                              : f.swap(a, bw, function() { return bB(a, b, d) })
               },
    ...
    f.expr && f.expr.filters &&
        (f.expr.filters.hidden =
         ...
         f.expr.filters.visible = function(
             a) { return !f.expr.filters.hidden(a) }),
  ...
  serializeArray : function() {
    ...
    f.each(
        "ajaxStart ajaxStop ajaxComplete ajaxError ajaxSuccess ajaxSend".split(
            " "),
        function(a, b) { f.fn[b] = function(a) { return this.on(b, a) } }),
    f.each([ "get", "post" ],
           function(a, c) {
    ...
    f.extend({
      ...
      ajax : function(a, c) {
        ...
        var d = f.ajaxSetup({}, c), e = d.context || d,
            ...
            h = f.Deferred(), i = f.Callbacks("once memory"),
            j = d.statusCode || {}, k, l = {}, m = {}, n, o, p, q, r, s = 0, t,
            u, v = {
              readyState : 0,
        ...
        h.promise(v),
            v.success = v.done, v.error = v.fail, v.complete = i.add,
            v.statusCode =
                function(a) {
              if (a) {
                var b;
            ...
            d.url =
                ((a || d.url) + "").replace(bF, "").replace(bK, bV[1] + "//"),
        ...
        if (s === 2)
          return !1;
        t = d.global, d.type = d.type.toUpperCase(),
  ...
  jsonpCallback : function() { return f.expando + "_" + cc++ }
                ...
                (j = j.replace(cd, l),
                 b.url === j &&
                     (e && (k = k.replace(cd, l)),
                      b.data === k && (j += (/\?/.test(j) ? "&" : "?") +
                                            b.jsonp + "=" + h))),
                b.url = j, b.data = k, a[h] = function(a) { g = [ a ] },
                d.always(function() {
    ...
    f.ajaxPrefilter("script", function(a) {
      ...
      if (a.crossDomain) {
        ...
        return {
          send: function(f, g) {
            d = c.createElement("script"), d.async = "async",
            a.scriptCharset && (d.charset = a.scriptCharset), d.src = a.url,
            d.onload = d.onreadystatechange = function(a, c) {
              if (c || !d.readyState || /loaded|complete/.test(d.readyState))
                d.onload = d.onreadystatechange = null,
                e && d.parentNode && e.removeChild(d), d = b,
                c || g(200, "success")
...
f.ajaxSettings.xhr =
    a.ActiveXObject ? function() { return !this.isLocal && ch() || ci() } : ch,
    function(a) {
    ...
    f.support.ajax && f.ajaxTransport(function(c) {
      if (!c.crossDomain || f.support.cors) {
        ...
        return {
          send: function(e, g) {
            var h = c.xhr(), i, j;
            c.username ? h.open(c.type, c.url, c.async, c.username, c.password)
...
f.fn.extend({
  ...
  animate : function(a, b, c, d) {
    function g() {
      ...
      var b = f.extend({}, e), c = this.nodeType === 1,
          d = c && f(this).is(":hidden"), g, h, i, j, k, l, m, n, o, p, q;
  ...
  stop : function(a, c, d) {
    ...
    return this.each(function() {
      ...
      if (a == null)
        for (b in g)
          g[b] && g[b].stop && b.indexOf(".run") === b.length - 4 &&
              h(this, g, b);
      else
    ...
    f.extend({
      ...
      easing : {
        ...
        swing : function(a) { return -Math.cos(a * Math.PI) / 2 + .5 }
      },
      timers : [],
      fx : function(a, b, c) {
    ...
    f.fx.prototype = {
      ...
      custom : function(a, c, d) {
        ...
        var e = this, g = f.fx;
        this.startTime = cq || cr(), this.end = c, this.now = this.start = a,
        this.pos = this.state = 0,
        this.unit = d || this.unit || (f.cssNumber[this.prop] ? "" : "px"),
        h.queue = this.options.queue, h.elem = this.elem,
        h.saveState =
            function() {
      ...
      step : function(a) {
        ...
        if (a || e >= i.duration + this.startTime) {
          ...
          if (g) {
            i.overflow != null && !f.support.shrinkWrapBlocks &&
                f.each(
                    [ "", "X", "Y" ],
                    function(a, b) { h.style["overflow" + b] = i.overflow[a] }),
                i.hide && f(h).hide();
            if (i.hide || i.show)
              for (b in i.animatedProperties)
        ...
        i.duration == Infinity
            ? this.now = e
            : (c = e - this.startTime, this.state = c / i.duration,
    ...
    f.each(cp.concat.apply([], cp), function(a, b) {
      b.indexOf("margin") &&
          (f.fx.step[b] = function(
               a) { f.style(a.elem, b, Math.max(0, a.now) + a.unit) })
    }), f.expr && f.expr.filters && (f.expr.filters.animated = function(a) {
          return f.grep(f.timers, function(b) { return a === b.elem }).length
        });
...
"getBoundingClientRect" in c.documentElement
    ? cv =
        ...
        var g = b.body, h = cy(b), i = c.clientTop || g.clientTop || 0,
            ...
            k = h.pageYOffset || f.support.boxModel && c.scrollTop ||
                g.scrollTop,
    ...
    : cv =
        ...
        while ((a = a.parentNode) && a !== h && a !== c) {
          ...
          a === e && (k += a.offsetTop, l += a.offsetLeft,
      ...
      f.offset = {
        ...
        setOffset : function(a, b, c) {
          ...
          var e = f(a), g = e.offset(), h = f.css(a, "top"),
              i = f.css(a, "left"),
              j = (d === "absolute" || d === "fixed") &&
                  f.inArray("auto", [ h, i ]) > -1,
              k = {}, l = {}, m, n;
          j ? (l = e.position(), m = l.top, n = l.left)
                   ...
                   if (g === b)
                     return h ? c in h
                                    ...
                                    : f.support.boxModel &&
                                          ...
                                          h.document.body[e]
                              : a[e];
                   h ? h.scrollTo(d ? f(h).scrollLeft() : g,
                                  d ? g : f(h).scrollTop())
                     : a[e] = g
      ...
      f.each({Height : "height", Width : "width"},
             function(a, c) {
               ...
               f.fn["inner" + a] = function() {
                 ...
                 var b = this[0];
                 return b ? b.style ? parseFloat(
                                          f.css(b, c, a ? "margin" : "border"))
                                    : this[c]()
                          : null
               }, f.fn[c] = function(a) {
      ...
      typeof define == "function" && define.amd && define.amd.jQuery &&
          define("jquery", [], function() { return f })
})(window);